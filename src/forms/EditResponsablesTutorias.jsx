...
function EditResponsablesTutorias({
  abierto,
  tutoria,
        ...
        <div className="bg-gray-50 flex justify-between items-center px-6 py-5 border-b border-gray-200 p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="block text-xs font-bold uppercase tracking-wide text-gray-400 mb-3">
...
export default EditResponsablesTutorias;